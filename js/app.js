...
console.log('%c Theme.bg v' + CONFIG.version + ' %c https://github.com/Codebglh/bg ', 'color: white; background: #e9546b; padding:5px 0;', 'padding:4px;border:1px solid #e9546b;')
